-- bases on https://github.com/trzecieu/clink-profile/blob/master/profile.lua
...
function git_prompt_filter()
    ...
    if get_git_dir() then
        ...
        if branch then
            ...
            content = color.."["..branch.."]"
        end
    end
    clink.prompt.value = interp(clink.prompt.value, {
        git = content
    })
    return false
end
...
-- priority in range (40, 60) to make sure this runs after npm but before git_prompt in clink-completions
